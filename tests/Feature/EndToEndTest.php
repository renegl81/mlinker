...
class EndToEndTest extends TestCase
{
    ...
    // =========================================================================
    // Flow 3: Onboarding creates location → menu → products sequentially
    // =========================================================================
    ...
    public function onboarding_wizard_creates_location_then_menu_then_products(): void
    {
        ...
        $tenant = Tenant::create(['id' => 'e2e-wizard-tenant']);
        ...
        // Step 0: create location
        $this->actingAs($user)->post($baseUrl.route('tenant.onboarding.location', [], false), [
            'name' => 'Mi Café',
