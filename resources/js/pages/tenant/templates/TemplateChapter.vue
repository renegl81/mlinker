...
import ChapterBody from '@/components/template-bodies/ChapterBody.vue';
...
const labels = computed(() => ({
    ...
    chapter_word: t('public_menu.chapter_word', 'Capítulo'),
    chapter_meta: t('public_menu.chapter_meta', 'Degustación'),
}));
